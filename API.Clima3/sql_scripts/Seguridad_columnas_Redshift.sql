...
GRANT ALL ON SCHEMA nicolas_terradas_coderhouse_secure TO data_scientist;
GRANT SELECT(name, dob, zip) ON nicolas_terradas_coderhouse_secure.my_secure_table TO data_scientist;
...
SELECT name, dob, zip
FROM nicolas_terradas_coderhouse_secure.my_secure_table;
